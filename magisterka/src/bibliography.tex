...
\bibitem[BerLand]{berland} Krste Asanov√≠c, Rastislav Bodik, Bryan Catanzaro, Joseph Gebis,
...
\bibitem[BoostThread]{boostthread} Anthony Williams, Boost.Thread Library \texttt{http://www.boost.org/doc/libs/release/libs/thread/index.html}.
...
\bibitem[UseC++]{usecpp} Gregory V. Wilson, Paul Lu, \textit{Parallel Programming Using C++ Scientific and Engineering Computation}, MIT Press, 1996.

\bibitem[Oracle]{oracle} \textit{Developing Parallel Programs ? A Discussion of Popular Models}, Oracle White Paper September 2010, \texttt{http://www.oracle.com/technetwork/server-storage/solarisstudio/documentation/oss-parallel-programs-170709.pdf}

\bibitem[OpenMP]{openmp} Ruud van der Pas - Sun Microsystems, \textit{An Overview of OpenMP}, 2009, \texttt{http://openmp.org/mp-documents/ntu-vanderpas.pdf}.

\bibitem[C++Lang]{c++lang} Bjarne Stroustrup, \textit{JÍzyk C++}, WNT, 2004.
