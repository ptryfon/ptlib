...
\subsection{Wykonanie zadañ}\label{ss:wykonywanie}
  ...
  Warto zauwa¿yæ, ¿e w bibliotece nie wystêpuje problem balansowania obci±¿enia ró¿nych w±tków, gdy¿ wszystkie w±tki nale¿±ce do puli s± identycznie i dziêki wykorzystaniu wspólnej kolejki zadañ, 
