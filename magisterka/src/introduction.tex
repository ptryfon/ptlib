...
\addcontentsline{toc}{chapter}{Wprowadzenie}
  ...
  W celu zapewnienia efektywno¶ci programu programista powinien uwzglêdniæ w projekcie równie¿ równowa¿enie obci±¿enia pomiedzy poszczególnymi w±tki.
  
  Programistê w zmaganiach z pisaniem programów wspó³bie¿nych wspieraj± ró¿norodne narzêdzia, s± to jêzyki programowania specjalnie zaprojektowane do obliczeñ równoleg³ych, takie jak Ada lub Erlang, 
  lub biblioteki oferuj±ce wykonywanie obliczeñ równoleg³ych w jêzykach sekwencyjnych.
  ...
  Ten przyk³ad obrazuje, w jaki sposób mo¿na wykorzystaæ bibliotekê Parallel do zrównoleglenia obliczeñ w podej¶ciu ``dziel i zwyciê¿aj'', polegaj±cym na dzieleniu problemu na kilka czê¶ci, z których ka¿da jest obliczana równolegle.
