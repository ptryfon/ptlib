...
\subsection{Threading Building Blocks (TBB)}
  ...
  Nawet optymalna liczba w±tków jest dobierana automatycznie przez TBB zale¿nie od konfiguracji komputera. TBB zawiera, oprócz schematu pêtli for, równie¿ wiele innych: schemat pêtli while, schemat pipeline, schemat reduce.

  Poni¿ej zaprezentowano przyk³ad wykorzystania biblioteki TBB do zrównoleglenia pêtli for.
...
\subsubsection{Porównanie Boost Thread vs. Parallel}
